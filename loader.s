;-------------------------------------------------------------------------------
; COVERT BITOPS Autoconfiguring Loader/Depacker V3.0
;-------------------------------------------------------------------------------

        ; NOTE: include config.s before the loader
...
Save            = $ffd8
        ...
        ; Loader runtime (default versions for fastloader)
...
ntscFlag:       dc.b 0
        ...
        ; Loader runtime ends, disposable part starts
